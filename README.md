# Batocera_LED_Battery_monitor
  ...
  Installation: 
         ...
         1) Put the Battery_monitor folder in the /userdata directory in Batocera ![GBA SP](https://github.com/nsilveri/Batocera_LED_Battery_monitor/blob/main/images/directory.png)
